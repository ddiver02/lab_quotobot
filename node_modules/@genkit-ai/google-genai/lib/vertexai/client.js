...
function getVertexAIUrl(params) {
  (0, import_utils3.checkSupportedResourceMethod)(params);
...
async function getHeaders(clientOptions) {
  if (clientOptions.kind == "express") {
    const headers = {
      "x-goog-api-key": (0, import_utils3.calculateApiKey)(clientOptions.apiKey, void 0),
      "Content-Type": "application/json",
      "X-Goog-Api-Client": (0, import_utils2.getGenkitClientHeader)(),
      "User-Agent": (0, import_utils2.getGenkitClientHeader)()
    };
    return headers;
  } else {
